...
#define exposure 1.0
#define blend_base 0.0     // 0.0 = white text, 1.0 = original colors
#define saturation 0.6     // 0.0 = black & white, 1.0 = full color
#define hue_shift 0.2      // 0.0 to 1.0
#define edge_strength 1.8
